#!/usr/bin/env bash
# Submit parametric fit aligned with generate_kinms_lensed_cube.py + simobserve mock40.
#
# Usage:
#   bash scripts/slurm/submit_kinms_mock_parametric_mock40.sh
set -euo pipefail
...
JOB_NAME="kinms_mock_parametric_mock40"
